    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-black/[0.96] antialiased bg-grid-white/[0.02]">
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        >
          ...
          >
            <Link href="https://github.com/yourusername" target="_blank" className="text-neutral-300 hover:text-white transition-colors duration-200">
            ...
            <Link href="https://linkedin.com/in/yourusername" target="_blank" className="text-neutral-300 hover:text-white transition-colors duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
